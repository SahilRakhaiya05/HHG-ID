(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 55682, (e, t, r) => {
    ...
    function i(e) {
        return "u" > typeof window && !!window.next.__pendingUrl && (0, u.createHrefFromUrl)(new URL(window.location.href)) !== (0, u.createHrefFromUrl)(window.next.__pendingUrl) && (console.error("Error occurred during navigation, falling back to hard navigation", e), window.location.href = window.next.__pendingUrl.toString(), !0)
    }
    ...
    for (var a in i) Object.defineProperty(r, a, {
        enumerable: !0,
        get: i[a]
    });
    ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
    ...
    function N(e, t, r) {
        ...
        return ! function e(t, r, n, i, a) {
            ...
            if (d) return a = a(t), d = "" === i ? "." + C(t, 0) : i, j(a) ? (n = "", null != d && (n = d.replace(w, "$&/") + "/"), e(a, r, n, "", function(e) {
                return e
            })) : null != a && (M(a) && (s = a, l = n + (null == a.key || t && t.key === a.key ? "" : ("" + a.key).replace(w, "$&/") + "/") + d, a = A(s.type, l, s.props)), r.push(a)), 1;
            d = 0;
            var p = "" === i ? "." : i + ":";
            if (j(t))
                for (var _ = 0; _ < t.length; _++) f = p + C(i = t[_], _), d += e(i, r, n, f, a);
            else if ("function" == typeof(_ = null === (c = t) || "object" != typeof c ? null : "function" == typeof(c = h && c[h] || c["@@iterator"]) ? c : null))
                for (t = _.call(t), _ = 0; !(i = t.next()).done;) f = p + C(i = i.value, _++), d += e(i, r, n, f, a);
            else if ("object" === f) {
    ...
    r.Activity = _, r.Children = {
    ...
    }, r.Component = O, r.Fragment = i, r.Profiler = s, r.PureComponent = R, r.StrictMode = a, r.Suspense = d, r.ViewTransition = b, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = T, r.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(e) {
        ...
        var n = m({}, e.props),
            o = e.key;
        if (null != t)
            for (u in void 0 !== t.key && (o = "" + t.key), t) x.call(t, u) && "key" !== u && "__self" !== u && "__source" !== u && ("ref" !== u || void 0 !== t.ref) && (n[u] = t[u]);
        ...
        var n, o = {},
            u = null;
        if (null != t)
            for (n in void 0 !== t.key && (u = "" + t.key), t) x.call(t, n) && "key" !== n && "__self" !== n && "__source" !== n && (o[n] = t[n]);
    ...
    }, r.startTransition = D, r.unstable_useCacheRefresh = function() {
